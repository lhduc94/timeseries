...
Như bảng trên, cột Date đầu tiên lưu trữ thông tin về Date và thường được sắp xếp theo thứ tự theo ngày (Date này theo Format M/D/Y). Dữ liệu thời gian không nhất thiết phải đầy đủm chúng ta có thể nhận thấy rằng tại ngày 12,13 tháng 1 năm 2021 và ngày 15,16 không có dữ liệu. có thể là do vấn đề về việc tổng hợp dữ liệu từ các bảng
