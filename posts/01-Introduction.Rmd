...
Ví dụ về Hình \@ref(fig:danso) thể hiện dân số Việt Nam có xu hướng tăng hằng năm
...
Ví dụ Hình \@ref(fig:tuvongtresosinh) về tỉ lệ tử vong của trẻ sơ sinh có xu hướng giảm dần thời gian nhờ có sự tiến bộ về y tế
