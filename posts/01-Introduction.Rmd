...
1. Array: Là dạng mảng các giá trị, thông thường trong timeseries phần tử có index lớn hơn sẽ là giá trị xuất hiện muộn hơn theo thứ tự thời gian. với dạng array của numpy, chúng ta có thể sử dụng một số phép  tính như shape, max/min, sum/cumsum, var/std, prod,cumprod
...
```
Hình \@ref(fig:chapter01_bitcoin) thể hiện Sự thay đổi của giá Bitcoin theo thời gian, giá bitcoin có xu hướng tăng mạnh từ giữa tháng 08/2020 đến 03/2021, đến tháng 11/2021 bắt đầu có xu hướng giảm dần
```{r  chapter01_bitcoin, echo=FALSE,  message=FALSE, warning=FALSE, fig.cap="Sự thay đổi giá Bitcoin theo thời gian", out.width="100%", fig.align="center"}
...
- Lượng quần áo mua cao nhất vào tháng 12 cuối năm và thấp nhất vào tháng 1 mỗi năm như mô tả trong Hình \@ref(fig:chapter01_seasonal)

```{r chapter01_seasonal, echo=FALSE,  message=FALSE, warning=FALSE, fig.cap="Lượng quán áo bán ra", out.width="100%", fig.align="center"}
