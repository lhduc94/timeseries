...
Mô hình cộng được sử dụng khi chuỗi thời gian có biên độ của thành phần mùa vụ tăng lên theo thời gian và sự thay đổi trong biên độ của thành phần mùa vụ quan trọng.
...
knitr::include_graphics("images/01/multiplicative_model.png.png")
```
