...
\includegraphics{../images/01/First-World-Infant-Mortality-Trends.jpg}
...
\includegraphics{../images/03/MA_model.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{c }\OperatorTok{=} \FloatTok{41.89874024}
\NormalTok{theta\_t }\OperatorTok{=} \FloatTok{0.17900771}
\NormalTok{theta\_t\_prev\_1 }\OperatorTok{=} \FloatTok{0.11330768}
\NormalTok{resid\_t }\OperatorTok{=} \OperatorTok{{-}}\FloatTok{2.94012608}
\NormalTok{resid\_t\_prev\_1 }\OperatorTok{=} \OperatorTok{{-}}\FloatTok{2.2677281}
\end{Highlighting}
\end{Shaded}
